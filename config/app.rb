Volt.configure do |config|
  ...
  #######################################
  config.domain = 'story-mapper-volt.com'
  config.app_name = 'Story_mapper_volt'
  config.mailer.from = 'Story_mapper_volt <no-reply@story-mapper-volt.com>'
  ...
  #
  config.app_secret = 'BmBJXMxNcaUbt2FxIDz9XsirYfnUaRgcDcFXGeKJK_BC2eS5_2J2OHgGC-bm3X8CLNQ'
